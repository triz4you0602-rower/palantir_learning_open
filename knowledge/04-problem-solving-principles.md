...
2. **사회적·정치적 직관:** Nabeel은 Keith Johnstone의 *Impro*(즉흥극 이론)를 인용 — 상/하 지위(status) 행동을 읽고 방을 파악하고 신뢰를 쌓는 것. *"성공적 FDE에는 사회적 맥락에 대한 비범한 민감성이 필요했다."*
...
1차 (내부자·경영진 발화):
- Nabeel Qureshi, "Reflections on Palantir" (8년 근무 회고) — 이 문서 다수 인용의 기반: https://nabeelqu.co/reflections-on-palantir
